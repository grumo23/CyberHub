...
public class info2 extends javax.swing.JFrame {
    ...
    public info2(String nombre, String lanzamiento, String desarrolladora, String plataformas, String formato, String descripcion, String id, String nombreUsu) {
        initComponents();
        this.idJuego = id;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            new info2(nombre, lanzamiento, desarrolladora, plataformas, formato, descripcion, id, nombreUsu).setVisible(true);
        }
        });
    }

...
public class info4 extends javax.swing.JFrame {
    ...
    public info4(String nombre, String lanzamiento, String desarrolladora, String plataformas, String formato, String descripcion, String id, String nombreUsu) {
        initComponents();
        this.idJuego = id;
        ...
        usuario.setText(nombreUsu);
         ...
         try {
                ...
                Image imagenEscalada = imagenOriginal.getScaledInstance(450, 300, Image.SCALE_SMOOTH);
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabelImagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 10, 580, 410));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            new info4(nombre, lanzamiento, desarrolladora, plataformas, formato, descripcion, id, nombreUsu).setVisible(true);
        }
        });
    }
